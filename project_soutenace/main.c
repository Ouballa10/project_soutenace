...
void menu() {
    ...
    printf("8. recherche des reservations par reference\n");
    printf("9. recherche des reservations par nom\n");
    printf("10. quitter\n");
...
void fakedata() {
    char fake_nom[10][50] = {"AMAL", "YASSMIN", "SAFA", "SOUAD", "HIND", "SOUMIYA", "SALAM", "SOUKAINA", "RANYA", "NOUHAILA"};
